...
- Formázás kizárólag az `utils/fmt.js`-ből (locale-érzékeny): fmtMin, fmtMinShort,
  fmtSignedMin, fmtNum, fmtNum1, fmtNum2, fmtPct, fmtYm, fmtYmFull, fmtDate, fmtCases,
  daysInMonth.
...
össze a `core.js`-ből és a nyolc feature-szótárból. Új kulcs mindhárom nyelven kötelező.
...
- Prioritás-színek: `--prio-p1..p4`, `prioColor('P1')`, badge: `prioBadge('P1')`.
  A `--prio-p5` és a `--prio-kp1` csak az `adatok` fül magyarázó legendájában szerepel,
  adat nem tartozik hozzájuk.
